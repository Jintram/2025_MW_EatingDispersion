...
- Update as of [4e9e111](https://github.com/Jintram/2025_MW_EatingDispersion/commit/4e9e1115bd6c6fccb50022c70e00542d0159b82b)
    - Structural changes to code to get rid of superfluous code
        - Function calls have changed, see `leafstats_project_example_1channel.py`,
        `leafstats_projects_example_3channels.py` for updated way to 
        run the script.
    - Additional statistics were tracked and plots where added;
        ...
        trends for this threshold per condition. 
            ...
            `plot_metric_per_condition` (see `leafstats_projects_example_3channels.py`).
            ...
            for the damage in `background_dmg.pdf` by `plot_metric_per_condition` (see `leafstats_projects_example_3channels.py` as well).
